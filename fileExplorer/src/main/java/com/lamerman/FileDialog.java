...
public class FileDialog extends ListActivity {
    ...
    public static final String CHECKBOX = "checkbox_default";
    /**
        ...
        selectButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedFile != null) {
                    ...
                    getIntent().putExtra(CHECKBOX, mCheckBox.isChecked());
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            if (file.canRead()) {
                ...
                new AlertDialog.Builder(this).setIcon(R.drawable.folder).setTitle("[" + file.getName() + "] " + getText(R.string.cant_read_folder)).setPositiveButton("OK", new DialogInterface.OnClickListener() {
