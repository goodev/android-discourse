        ...
        public boolean nextFrame(Handler handler) throws IOException {
            ...
            if (control) {
                ...
                switch (type) {
                    ...
                    case TYPE_NOOP:
                        if (length != 0)
                            throw ioException("TYPE_NOOP length: %d != 0", length);
                        handler.noop();
                        return true;
