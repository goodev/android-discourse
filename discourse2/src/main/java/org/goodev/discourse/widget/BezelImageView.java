...
/**
 * An {@link android.widget.ImageView} that draws its contents inside a mask and draws a border drawable on top. This is useful for applying
 * a beveled look to image contents, but is also flexible enough for use with other desired aesthetics.
 */
