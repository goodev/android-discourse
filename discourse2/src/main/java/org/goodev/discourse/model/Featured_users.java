...
public class Featured_users {
    ...
    public Featured_users(final Cursor cursor) {
        setId(cursor.getLong(cursor.getColumnIndex(Featured_usersTable.ID)));
        setUid(cursor.getLong(cursor.getColumnIndex(Featured_usersTable.UID)));
        setUsername(cursor.getString(cursor.getColumnIndex(Featured_usersTable.USERNAME)));
        setAvatar_template(cursor.getString(cursor.getColumnIndex(Featured_usersTable.AVATAR_TEMPLATE)));
    ...
    public void setId(final Long id) {
        this.id = id;
        this.values.put(Featured_usersTable.ID, id);
    }
    ...
    public void setUid(final long uid) {
        this.uid = uid;
        this.values.put(Featured_usersTable.UID, uid);
    }
    ...
    public void setUsername(final java.lang.String username) {
        ...
        this.values.put(Featured_usersTable.USERNAME, username);
    }
    ...
    public void setAvatar_template(final java.lang.String avatar_template) {
        ...
        this.values.put(Featured_usersTable.AVATAR_TEMPLATE, avatar_template);
    }
