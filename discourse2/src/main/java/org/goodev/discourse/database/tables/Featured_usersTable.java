...
/**
 * This interface represents the columns and SQLite statements for the featured_usersTable.
 * This table is represented in the sqlite database as featured_users column.
 * <p/>
 ...
 * @date 2013.09.22
 */
public interface Featured_usersTable {
    String TABLE_NAME = "featured_users";
